...
export default function AdminProducts() {
  ...
  const handleBlockProduct = async (id, isBlocked) => {
    try {
      const response = await (isBlocked ? unblockProductApi(id) : blockProductApi(id));
      if (response.data.success) {
        toast({
          title: "Success",
          description: `Product ${isBlocked ? 'unblocked' : 'blocked'} successfully!`,
          variant: "default",
        });
      ...
      console.error("Error handling product block/unblock: ", error);
      toast({
        title: "Error",
                    ...
                    >
                      ...
                      <td className="p-3 text-right space-x-2 whitespace-nowrap">
                        ...
                        {product.isBlocked ? (
                          ...
                          >
                            <Trash className="h-4 w-4 mr-1" /> Block
                          </Button>
                        )}
                      </td>
                    </tr>
