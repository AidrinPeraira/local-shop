...
import { getReturnRequestsApi, updateReturnRequestApi } from "../../api/returnApi";
              ...
              {returns.map((returnRequest) => (
                <React.Fragment key={returnRequest._id}>
                  <tr className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-3">{getStatusBadge(returnRequest.status)}</td>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            variant="outline"
                            size="sm"
                            disabled={["REFUND_COMPLETED", "CANCELLED"].includes(
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div>
                                ...
                                <p>{returnRequest.items[0].returnReason}</p>
                              </div>
                            </div>
                          </div>
                          <div>
