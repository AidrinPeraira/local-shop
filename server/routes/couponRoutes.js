...
import { adminCreateCoupon, adminDeleteCoupon, adminGetCoupons, adminUpdateCoupon, getBuyerCoupons } from "../controller/couponController.js";


const couponRoutes = express.Router();

couponRoutes.route("/get/applicable").get(authenticateUser, getBuyerCoupons);
